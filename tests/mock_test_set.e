...
feature -- Test routines
	...
	mock_tests
		...
		do
			...
			l_sql := db_factory.generate_new_table_from_template_sql (l_item, l_template)
			assert_strings_equal ("mock_creation_sql", " CREATE TABLE  IF NOT EXISTS mock_one (mock_pk INTEGER  PRIMARY KEY  ASC  AUTOINCREMENT , created_on_db TEXT  DESC ,modified_on_db TEXT  DESC ,mock_text_field_db TEXT  ASC ,mock_date_field_db TEXT  ASC ,mock_bool_field_db INTEGER  ASC ,mock_int_field_db_desc INTEGER  DESC );", l_sql)
...
feature -- Constants
	...
	db_file_name: STRING = "test.sqlite3"
